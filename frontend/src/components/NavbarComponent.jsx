  ...
  return (
    <nav className="bg-white h-16 text-black flex items-center justify-between px-20 min-w-fit">
      <div className="flex items-center gap-2">
        <Link to="/home" className={`flex items-center ${location.pathname === '/' ? 'active' : 'inactive'}`} style={{ opacity: location.pathname === '/' ? 1 : 0.5 }}>
      ...
      <div className="flex gap-4 items-center justify-center">
        ...
        {isLoggedIn ? (
          <Link to="/" className='bg-[#C0772C] px-3 py-2 rounded-sm flex items-center' onClick={handleLogout}>
